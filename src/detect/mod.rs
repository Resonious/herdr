...
mod tests {
    ...
    fn identify_known_agents() {
        ...
        assert_eq!(identify_agent("ante"), Some(Agent::Ante));
    ...
    fn parse_known_agent_labels() {
        ...
        assert_eq!(parse_agent_label("ante"), Some(Agent::Ante));
        assert_eq!(parse_agent_label("ante.exe"), Some(Agent::Ante));
    }
